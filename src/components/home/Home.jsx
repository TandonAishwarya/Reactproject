            ...
            <div className="container text-center">
                <div className="row mt-5 d-flex">
                    ...
                    <div className="">
                        ...
                        <p className="">
                            Department of Chemicals and Petrochemicals (DCPC) aims:<br/>
                            ...
                            To foster the spirit of public-private partnership for overall development of above mentioned sectors of the industry.<br/>
                            The Department has the mandate to deal with the following broad subject matters:<br/>

                            Insecticides excluding the administration of The Insecticides Act, 1968 (46 of 1968);<br/>
                            Dye-stuffs and Dye-Intermediates;<br/>
                            All organic and inorganic chemicals, not specifically allotted to any other Ministry or Department;<br/>
                            Planning, development and assistance to all industries dealt with by the Department;<br/>
                            Bhopal Gas Leak Disaster-Special Laws relating thereto;<br/>
                            Petrochemicals;<br/>
                            Industries relating to production of non-cellulosic synthetic fibers (Nylon Polyesters, Acrylic etc.);<br/>
                            Synthetic Rubber; and
                            Plastics including fabrication of plastic and moulded goods.
                            The Department has five major divisions viz. Chemicals, Petrochemicals, Administration, Statistics & Monitoring (S&M) and Economic Division. The Internal Finance Division is common to the three Departments in the Ministry of Chemicals and Fertilizers. There are three Central Public Sector Undertakings (CPSU) in the chemical sector namely Hindustan Organic Chemicals Ltd. (HOCL), HIL (India) Limited and Hindustan Fluorocarbons Limited (HFL), which is a subsidiary of HOCL. The autonomous institutes under this Department are Central Institute of Petrochemicals Engineering & Technology (CIPET) and Institute of Pesticides Formulation Technology (IPFT).<br/>
                            Dr. Mansukh Mandaviya is the Minister of Chemicals and Fertilizers. Shri Bhagwanth Khuba is the Minister of State for Chemicals and Petrochemicals. Ms Arti Ahuja assumed charge as Secretary in the Department on 14.02.2022.<br/>
                        </p>
                    </div>
                    </div>
